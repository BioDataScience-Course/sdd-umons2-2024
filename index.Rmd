...
-   des diapositives de présentations distribuées via le dépôt [sdd_lessons sur BioDataScience-Course](https://github.com/BioDataScience-Course/sdd_lessonstree/2024-2025).
...
| 8 AFM             | `r !"{W[26]+1}"`        | `r !"{W[27]+1}"` | **début `r !"{W[26]+1}"`** |                      | **`r !"{W[26]+5}"`** |
| 9 MDS             | `r !"{W[30]+1}"`        | `r !"{W[31]+1}"` | **continue...**            |                      | **`r !"{W[30]+5}"`** |
